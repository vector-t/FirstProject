...
public class UIRichLabel : UIWidget
{
	...
	public override bool isAnchoredHorizontally { get { return base.isAnchoredHorizontally || mOverflow == UILabel.Overflow.ResizeFreely; } }
	...
	public override bool isAnchoredVertically
	{
		get
		{
			return base.isAnchoredVertically ||
				mOverflow == UILabel.Overflow.ResizeFreely ||
				mOverflow == UILabel.Overflow.ResizeHeight;
		}
	}
	...
	bool keepCrisp
	{
		get
		{
			if (trueTypeFont != null && keepCrispWhenShrunk != UILabel.Crispness.Never)
			{
				...
				return (keepCrispWhenShrunk == UILabel.Crispness.Always);
#else
				return true;
#endif
			}
	...
	public int maxLineCount
	{
		...
		set
		{
			if (mMaxLineCount != value)
			{
				...
				shouldBeProcessed = true;
				if (overflowMethod == UILabel.Overflow.ShrinkContent) MakePixelPerfect();
			}
		}
	}
	...
	public Color effectColor
	{
		...
		set
		{
			...
			{
				mEffectColor = value;
				if (mEffectStyle != UILabel.Effect.None) shouldBeProcessed = true;
			}
		}
	}

	/// <summary>
	/// UILabel.Effect distance in pixels.
	/// </summary>
	...
	public bool shrinkToFit
	{
		get
		{
			return mOverflow == UILabel.Overflow.ShrinkContent;
		}
		set
		{
			if (value)
			{
				overflowMethod = UILabel.Overflow.ShrinkContent;
			}
		}
	}
	...
	protected override void UpgradeFrom265 ()
	{
		...
		{
			width = mMaxLineWidth;
			overflowMethod = mMaxLineCount > 0 ?UILabel.Overflow.ResizeHeight :UILabel.Overflow.ShrinkContent;
		}
		else overflowMethod =UILabel.Overflow.ResizeFreely;
	...
	protected override void OnAnchor ()
	{
		...
		{
			if (isFullyAnchored)
				mOverflow =UILabel.Overflow.ShrinkContent;
		}
	...
	public override void MakePixelPerfect ()
	{
		if (ambigiousFont != null)
		{
			...
			else
			{
				...
				UILabel.Overflow over = mOverflow;
				if (over !=UILabel.Overflow.ResizeHeight) mWidth = 100000;
				mHeight = 100000;
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		// UILabel.Effects don't work with packed fonts
		if (mFont != null && mFont.packedFontShader) return;

		// Apply an effect if one was requested
		if (effectStyle != UILabel.Effect.None)
		{
			int end = verts.size;
			...
			if ((effectStyle == UILabel.Effect.Outline) || (effectStyle == UILabel.Effect.Outline8))
			{
				offset = end;
				end = verts.size;
				...
				if (effectStyle == UILabel.Effect.Outline8)
				{
					offset = end;
					end = verts.size;
	...
	/// <summary>
	/// Update NGUIExText.current with all the properties from this label.
	/// </summary>

	public void UpdateNGUIExText ()
	{
